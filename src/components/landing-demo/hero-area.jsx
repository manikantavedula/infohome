...
const HeroArea = () => {
  ...
  return (
    <div
      className="hero-banner presentation-hero-style pv-hero-banner bg-image"
      id="intro"
    >
          ...
          <div className="col-lg-10">
            <div className="banner-content">
              ...
              <h1
                ...
                data-sal-duration="1000"
              >
                Infopublishers Education & Online Course HTML Template
              </h1>
              <div
              ...
              >
                <a
                  ...
                  className="edu-btn"
                >
                  Download Infopublishers Now <i className="icon-4"></i>
                </a>
              </div>
            </div>
          </div>
