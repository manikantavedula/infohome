  ...
  return (
    <section className="why-choose-area-2 section-gap-large">
      <div className="container edublink-animated-shape">
        ...
        >
          <span className="pre-title">Why choose Infopublishers</span>
          <h2 className="title">
            The Best <span className="color-secondary">Beneficial</span> Side{" "}
            <br /> of Infopublishers
          </h2>
        ...
        <div className="row g-5">
          <ChoseBox
            ...
            subtitle="Lorem ipsum dolor sit amet conset ur elit sed eiusmod ex tempor inc labore dolore magna."
          />
