            ...
            <div className="about-content">
              ...
              >
                <span className="pre-title pre-textsecondary">
                  Welcome to the Infopublishers
                </span>
                <h2 className="title">
                  Welcome To Best Preschool Class Center
                </h2>
              ...
              >
                <div className="row g-5 row--20">
                  <div className="col-lg-6">
                    ...
                    <p>
                      Magna aliquaenim minim veniamquis nostrud exercitation
                      ulamco laboris Lorem ipsum dolor sit amet.
                    </p>
                  ...
                  <div className="col-lg-6">
                    ...
                    <p>
                      Consectetur do eius adipisicing elit sed do eius tempor
                      incididunt labore.
                    </p>
                    <p>
                      dolore magna aliqua. Ut enim ad minim veniam quis nosud
                      exercitation ulamco.
                    </p>
                  </div>
                </div>
