        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="banner-content">
              ...
              >
                Find Your Best <br /> Courses to{" "}
                <span className="color-secondary">Develope</span> <br />
                your skills
              </h1>
              <p
                data-sal-delay="200"
          ...
          <div className="col-lg-6">
            <div className="banner-thumbnail">
              ...
              >
                <img
                  src="/assets/images/banner/home8-vactor-bg.webp"
                  alt="vactor Image"
                />
              </div>
              ...
              <ul className="shape-group">
                ...
                <motion.li
                  className="shape-4 scene shape-light"
                  data-sal-delay="1000"
                  data-sal="fade"
                  data-sal-duration="1000"
                  animate={{
                ...
                <motion.li
                  className="shape-4 scene shape-dark"
                  data-sal-delay="1000"
                  data-sal="fade"
                  data-sal-duration="1000"
                  animate={{
